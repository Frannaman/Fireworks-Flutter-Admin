  ...
  Widget build(BuildContext context) {
    ...
    child: Image(
        image: notifire.isDark
          ? const AssetImage('assets/Symbol_Dark.png') // Dark mode image
          : const AssetImage('assets/Symbol.png'), // Light mode image
                )),
                          ...
                          InkWell(
                              ...
                              child: Text('Evalyt', style: TextStyle(fontFamily: 'Jost-SemiBold', fontSize: 25,color: notifire.textcolore, fontWeight: FontWeight.bold), overflow: TextOverflow.ellipsis)),
                        ],
                      ),
                      // Column(
                      //    children: [
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  decoration: BoxDecoration(
                                      color: inboxController.pageselecter == 1? notifire.deercolore:Colors.transparent,
                                      borderRadius: BorderRadius.circular(15)
                                  ),
                                  child: ListTile(
                                    onTap: () {
                                    ...
                                    title: Text('Health Checker', style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 13,
                                        color: inboxController.pageselecter == 1 ? notifire.drwetextcode : notifire.textcolore),),
                                    leading:  Image(
                                        image: const AssetImage('assets/3.png'),height: 20,width: 20, color: inboxController.pageselecter == 1 ? notifire.drwetextcode : notifire.textcolore),
                                  ),
                                ),
                               /* Container(
                                  decoration: BoxDecoration(
                                  ...
                                  child: ListTile(
                                    ...
                                    title: Text('All Widget', style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 13,
                                ...
                                const SizedBox(height: 10,),
                                Text('Data Management',style: TextStyle(fontSize: 15,color: notifire.textcolore)),
                                const SizedBox(height: 10,),
                                ...
                                Container(
                                  decoration: BoxDecoration(
                                      color: inboxController.pageselecter == 2? notifire.deercolore:Colors.transparent,
                                      borderRadius: BorderRadius.circular(15)
                                  ),
                                  child: ListTile(
                                    onTap: () {
                                    ...
                                    trailing: const SizedBox(),
                                    title: Text('Data Audit', style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 13,
                                        color: inboxController.pageselecter == 2 ? notifire.drwetextcode : notifire.textcolore),),
                                    leading:  Image(
                                        image: const AssetImage('assets/6.png'),height: 20,width: 20, color: inboxController.pageselecter == 2 ? notifire.drwetextcode : notifire.textcolore),
                                  ),
                                ),
                                Container(
                                  decoration: BoxDecoration(
                                  ...
                                  child: ListTile(
                                    ...
                                    trailing: const SizedBox(),
                                    title: Text('Azure Audit', style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 13,
                                ...
                                Container(
                                  ...
                                  child: ListTile(
                                   ...
                                   /* trailing: Container(
                                    ...
                                    title: Text('Security Audit', style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 13,
